...
import (
	...
	"github.com/AnirudhAgnihotri2902/jwt-using-go-and-postgres/hashings"
	"github.com/AnirudhAgnihotri2902/jwt-using-go-and-postgres/queries"
...
func Signup(w http.ResponseWriter, r *http.Request) {
	...
	if _, err = queries.CreateUser(ctx, client, uname, upassword); err != nil {
		w.WriteHeader(http.StatusBadRequest)
	}
...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	uname = credentials.Username
	var u, erro = queries.QueryUser(ctx, client, uname)
	if erro != nil {
